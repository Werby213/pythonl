...
class Space_dust(pygame.sprite.DirtySprite):
    ...
    def __init__(self, center):
        ...
        self.speedy = random.randrange(-25, 5)
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, pos):
        ...
        self.image = pygame.transform.rotate(self.image, -self.spread)


    def update(self):
        self.rect.move_ip(self.spread+self.spread, -60)
        if self.rect.top < 0:
            self.kill()
